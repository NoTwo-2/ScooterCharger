...
CREATE TABLE APPUSER (
	...
	RESERVED_CS_ID INT,
	RESERVED_CS_SPACE_I INT,
	VERIFICATION_TOKEN VARCHAR(100),
	IS_VERIFIED INT DEFAULT 0,

	FOREIGN KEY (RESERVED_CS_ID) REFERENCES CHARGING_STATION(CS_ID));

CREATE TABLE CHARGING_STATION (
	CS_ID INTEGER PRIMARY KEY,
	CS_LAST_UPDATE TIMESTAMP,
	CS_NAME VARCHAR(50),
	CS_GMAPS_LINK VARCHAR(150),
	CS_ADDRESS VARCHAR(150));
